...
//    TODO ????
    ...
    @Test
    public void getEncode() throws UnsupportedEncodingException {
        assertEquals("Доброе утро, ", grt.getEncode("Morning", res_ru));
        assertEquals("Good night, ", grt.getEncode("Night", res_en));
    }
}